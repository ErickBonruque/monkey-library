...
const exitsChartConfig = {
  baixas: { label: "Baixas", color: "var(--chart-1)" },
} satisfies ChartConfig

const categoriesChartConfig = {
  quantidade: { label: "Produtos", color: "var(--chart-2)" },
} satisfies ChartConfig
...
export default function DashboardPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Dashboard"
        description={`Visão geral do estoque — ${format(new Date(), "dd 'de' MMMM 'de' yyyy", { locale: ptBR })}`}
      />
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Baixas por Mês</CardTitle>
          </CardHeader>
          <CardContent>
